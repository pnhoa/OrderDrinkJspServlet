...
/**
 * Servlet implementation class MenuDaXay
 */
@WebServlet("/menuDaXay")
public class MenuDaXay extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Drinks> drinkList = drinkDao.getAllDaXay();

		request.setAttribute("drinkList", drinkList);
		request.setAttribute("daxayMessage", "Các loại Vitamin Đá Xay");
