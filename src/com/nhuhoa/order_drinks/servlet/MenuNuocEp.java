...
/**
 * Servlet implementation class MenuNuocEp
 */
@WebServlet("/menuNuocEp")
public class MenuNuocEp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Drinks> drinkList = drinkDao.getAllNuocEp();

		request.setAttribute("drinkList", drinkList);
		request.setAttribute("nuocepMessage", "Các loại Nước Trái Cây");
